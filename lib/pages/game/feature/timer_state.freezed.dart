...
abstract class $TimerStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AnimationController? animationController});
}
...
class _$_TimerState extends _TimerState {
  const _$_TimerState({this.animationController}) : super._();
  ...
  @override
  String toString() {
    return 'TimerState(animationController: $animationController)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, animationController);
...
abstract class _TimerState extends TimerState {
  const factory _TimerState({final AnimationController? animationController}) =
      _$_TimerState;
